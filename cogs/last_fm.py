...
from setting import MUSIC_TOKEN,embed_color
...
class MusicCog(commands.Cog,name='music'):
    ...
    async def get_lyrics(self, ctx: discord.ext.commands.context.Context, *, args: str) -> None:
        ...
        try:
            ...
            embed = discord.Embed(title=f"{data['name']} by {data['artist']['name']}", url=data['url'],color=embed_color)
    ...
    async def getalbum(self, ctx: discord.ext.commands.context.Context, *, args: str) -> None:
        ...
        try:
            ...
            embed = discord.Embed(title=title, url=data['album']['url'],color=embed_color)
    ...
    async def getartist(self, ctx: discord.ext.commands.context.Context, *, args: str) -> None:
        ...
        try:
            ...
            if bio == '':
                bio = data['bio']['summary'].split('\n', 2)[1].split('<a', 1)[0]
            embed = discord.Embed(title=data['name'], url=data['url'], description=bio,color=embed_color)
    ...
    async def topsongs(self, ctx: discord.ext.commands.context.Context) -> None:
        ...
        em = discord.Embed(title='Top 10 Tracks', url='https://www.last.fm/charts',color=embed_color)
    ...
    async def topartists(self, ctx: discord.ext.commands.context.Context) -> None:
        ...
        embed = discord.Embed(title='Top 10 Artists', url='https://www.last.fm/charts',color=embed_color)
